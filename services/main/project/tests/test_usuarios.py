...
class TestUsuarioService(BaseTestCase):
    ...
    def test_add_persona(self):
        ...
        with self.client:
            ...
            self.assertIn('nicole.garcia@gmail.com was added!',
                          data['message'])
            self.assertIn('success', data['status'])

    def test_add_persona_invalid_json(self):
        """Asegúrese de que se produzca un error si el objeto JSON
        está vacío."""
    ...
    def test_add_persona_invalid_json_keys(self):
        """
        Asegúrese de que se produzca un error si el objeto JSON no tiene
